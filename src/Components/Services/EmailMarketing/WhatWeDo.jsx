...
const WhatWeDo = () => {
    const SMMData = [
        {
            key: 1,
            image:'/assets/Email/EmailImg4.png',
            btnText:'Targeted Campaigns',
            desc:'Customize your marketing initiatives to reach your target audience and increase the effect of your message.',
        },
        {
            key: 2,
            image:'/assets/Email/EmailImg2.png',
            btnText:'Personalization',
            desc:'Deliver personalized experiences that resonate with customers, forging stronger connections and driving conversions.',
        },
        {
            key: 3,
            image:'/assets/Email/EmailImg3.png',
            btnText:'Data Analysis',
            desc:'Harness the power of data to gain valuable insights, optimise strategies, and make data-driven decisions.',
        },
    ]
