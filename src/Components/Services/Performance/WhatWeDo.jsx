...
const WhatWeDo = () => {
    const SMMData = [
        {
            key: 1,
            image:'/assets/Performance/PMImg1.png',
            btnText:'Drive Results',
            desc:'Develop data-driven marketing strategies tailored to your business goals.',
        },
        {
            key: 2,
            image:'/assets/Performance/PMImg2.png',
            btnText:'Targeted Campaigns',
            desc:'Reach the right audience through precise audience targeting and segmentation.',
        },
        {
            key: 3,
            image:'/assets/Performance/PMImg3.png',
            btnText:'Optimize Conversions',
            desc:' Continuously refine campaigns to maximize conversions and drive higher ROI.',
        },
    ]
