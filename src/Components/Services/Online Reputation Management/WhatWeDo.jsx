...
const WhatWeDo = () => {
    const SMMData = [
        {
            key: 1,
            image:'/assets/ORM/OMRImg1.png',
            btnText:'Consistent Online Reputation Monitoring',
            desc:'Goals are set, audiences are understood, and effective strategies take shape to increase the reach',
        },
        {
            key: 2,
            image:'/assets/ORM/OMRImg2.png',
            btnText:'Promoting the brand image for a positive impact',
            desc:'Goals are set, audiences are understood, and effective strategies take shape to increase the reach',
        },
        {
            key: 3,
            image:'/assets/ORM/OMRImg4.png',
            btnText:'Social Media Monitoring & Analytics',
            desc:'Goals are set, audiences are understood, and effective strategies take shape to increase the reach',
        },
    ]
