...
const WhatWeDo = () => {
    const SMMData = [
        {
            key: 1,
            image:'/assets/VideoMarketing/VMImg1.png',
            btnText:'Storytelling through Video',
            desc:"Engage and mesmerise your audience with compelling video content that tells your brand's story",
        },
        {
            key: 2,
            image:'/assets/VideoMarketing/VMImg2.png',
            btnText:'Audience Targeting',
            desc:'Reach the right audience with precision and target your marketing efforts to maximise results.',
        },
        {
            key: 3,
            image:'/assets/VideoMarketing/VMImg3.png',
            btnText:'Performance Tracking and Analysis',
            desc:'Monitor and analyse the performance of your campaigns to optimise strategies and achieve better results.',
        },
    ]
