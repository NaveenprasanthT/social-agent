...
const HeroSection = () => {
    return (
        <div className={styles.sectionWrap}>
            ...
            <Image 
                src='/assets/Photography/Photography1.png' 
                width={150} 
                height={100}
                className={styles.MessageIcon}    
            />
            <Image 
                src='/assets/Photography/Photography2.png' 
                width={150} 
                height={100}
                className={styles.HeartbeatIcon}     
            />
            <Image 
                src='/assets/Photography/Photography3.png' 
                width={150} 
                height={100}
            ...
            />
            <Image 
                src='/assets/Photography/Photography5.png' 
                width={150} 
                height={100}
