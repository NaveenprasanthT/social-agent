...
const WhatWeDo = () => {
    const SMMData = [
        {
            key: 1,
            image:'/assets/Whatsapp/WMImg1.png',
            btnText:'Engage with customers via WhatsApp',
            desc:'Connect directly with customers on WhatsApp to provide personalized support, answer queries, and build strong relationships.',
        },
        {
            key: 2,
            image:'/assets/Whatsapp/WMImg2.png',
            btnText:'Build Customer Relationships',
            desc:' Foster meaningful connections with customers through exceptional service, genuine interactions, and tailored experiences.',
        },
        {
            key: 3,
            image:'/assets/Whatsapp/WMImg4.png',
            btnText:'Promote Products and Services',
            desc:'Effectively market and showcase your products and services to a wider audience, driving engagement and boosting sales.',
        },
    ]
